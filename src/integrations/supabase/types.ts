  ...
  public: {
    Tables: {
      carbon_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "carbon_tokens_farmer_id_fkey"
            columns: ["farmer_id"]
            isOneToOne: false
      ...
      purchases: {
        Row: {
          ...
          decentro_payment_ref: string | null
          farmer_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "purchases_farmer_id_fkey"
            columns: ["farmer_id"]
            isOneToOne: false
            referencedRelation: "farmers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "purchases_token_id_fkey"
            columns: ["token_id"]
            isOneToOne: false
            referencedRelation: "carbon_tokens"
            referencedColumns: ["id"]
          },
        ]
      }
